...
public class ImpresorLCD {
     ...
     *
     * Defino los diferentes segmentos usados para imprimir cada digito
     *
     ...
     *
     * Los digitos entrado por el usario == case que en turno define los segmentos imprimidos para formar el digito
     *
     * @param numero Digito
     */
     ...
     *
     * Defina numero del lineas y columnas necesarios para imprimir el digito basado en tamaño
     *
    ...
    private void imprimirNumero(int tamaño, String numeroImp, int espacio) 
    {
        ...
        this.filasDig = (2 * this.tamaño) + 3;

        // Calcula el numero de columnas de cada digito
        this.columDig = this.tamaño + 2;
     ...
     *
     * @param comando es la entrada que contiene el 'tamaño' del segmento de los digito
     * y el numero para imprimir
      *
     * @param espacioDig es el espacio entre digitos
     */  
    public void procesar(String comando, int espacioDig) {
        ...
        if (!comando.contains(",")) {
            throw new IllegalArgumentException("Cadena " + comando
                    + " no tiene caracter ',' separarando el tamaño y el digito");
        }
        ...
        {
           throw new IllegalArgumentException("Cadena " + comando
                    + " contiene demasiados parametros");
        }
        ...
        {
           throw new IllegalArgumentException("Cadena " + comando
                    + " no contiene los dos parametros requeridos");
        }
        ...
        if(isNumeric(parametros[0]))
        {
            ...
            if(tam <1 || tam >10)
            {
                throw new IllegalArgumentException("El parametro de tamaño ["+tam
                        + "] debe ser entre 1 y 10");
            }
        }
        else
        {
            throw new IllegalArgumentException("Parametro de tamaño [" + parametros[0]
                    + "] no es un numero");
        }
